...
- main:
  ...
  - img: procedural episodic semantic working 0 15 30 45 60
  ...
  - img:
    ...
    - img
    - img
    - text: claude-code 92% claude-opus-4-20250514 3% claude-sonnet-4 2% test-agent-project-fix-v2 1% test-agent-project-fix 1% claude-code-assistant 1%
  - heading "Recent Memory Activity (10 of 15 (121 total))" [level=3]
  - paragraph:
